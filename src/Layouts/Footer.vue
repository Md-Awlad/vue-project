<template lang="">
  <div>
    <div class="relative flex justify-start md:justify-center md:items-end">
      <img
        class="absolute object-cover top-10 h-full w-full z-0"
        src="https://tuk-cdn.s3.amazonaws.com/can-uploader/footer_5_marketing_background.png"
        alt="background"
      />
      <div
        class="flex pt-36 md:pt-32 lg:pt-40 xl:pt-60 px-4 md:px-6 xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10"
      >
        <div
          class="flex flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row"
        >
          <div class="flex justify-start items-center space-x-4">
            ...
            <p
              class="w-60 text-xl xl:text-2xl font-semibold leading-normal text-white"
            >
              The North
            </p>
          </div>
          ...
          >
            <div
              class="sm:w-40 md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6"
            >
              <h2
                class="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-white"
              >
                Community
              </h2>
              <button
                class="text-left text-base hover:text-gray-400 leading-none text-gray-100"
              >
                About Us
              </button>
              <button
            ...
            <div
              class="xl:w-72 flex justify-start items-start flex-col space-y-6"
            >
              <h2
                class="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-white"
              >
              ...
              <button
                class="text-base text-left hover:text-gray-400 leading-none text-gray-100"
              >
                Accessibility
              </button>
              <button
        ...
        <div
          class="mt-12 flex xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full"
        >
          ...
          >
            <button
              class="text-base leading-none text-white hover:text-gray-300"
            >
              Terms of service
            </button>
            <button
          ...
          <div
            class="flex justify-start md:justify-end items-start w-full md:w-auto md:items-center space-x-6"
          >
